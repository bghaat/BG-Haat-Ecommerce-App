...
public class TinyDB {
    ...
    public ArrayList<NewArrivalModel> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<NewArrivalModel> playerList =  new ArrayList<NewArrivalModel>();

        for(String jObjString : objStrings){
            NewArrivalModel player  = gson.fromJson(jObjString,  NewArrivalModel.class);
    ...
    public void putListObject(String key, ArrayList<NewArrivalModel> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(NewArrivalModel player: playerList){
